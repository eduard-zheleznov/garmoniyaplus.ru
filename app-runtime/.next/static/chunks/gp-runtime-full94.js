;(function(){
try{
if(window.__gpActionsSync20260618Full94)return;
window.__gpActionsSync20260618Full94=true;
...
function gpDecodeMojibakeText94(value){
...
function gpNormalizeMojibakeText94(root){
  ...
  try{
    ...
    while((textNode=walker.nextNode())&&limit<600){
      limit+=1;
      var decoded=gpDecodeMojibakeText94(textNode.nodeValue);
  ...
  try{
    [].slice.call(root.querySelectorAll("[aria-label],[title],[placeholder],[alt]")).forEach(function(node){
      ["aria-label","title","placeholder","alt"].forEach(function(attr){
        ...
        var decoded=gpDecodeMojibakeText94(current);
...
function gpInstallMojibakeObserver94(){
  if(window.__gpMojibakeObserver94)return;
  window.__gpMojibakeObserver94=true;
  try{
    new MutationObserver(function(mutations){
      ...
      if(!shouldRun)return;
      clearTimeout(window.__gpMojibakeTimer94);
      window.__gpMojibakeTimer94=setTimeout(function(){gpNormalizeMojibakeText94(document.body)},80);
...
function ensureFavoritesCard93Style(){
  if(document.getElementById("gp-textfix94-style"))return;
  var style=document.createElement("style");
  style.id="gp-textfix94-style";
  style.textContent=[
...
function run(){
  ...
  if(gpIsMobileAccountFast84(path)){
    ...
    gpInstallMojibakeObserver94();
    gpNormalizeMojibakeText94(document.body);
    return;
  }
  gpInstallMojibakeObserver94();
  ...
  gpNormalizeMojibakeText94(document.body);
  setTimeout(function(){gpNormalizeMojibakeText94(document.body)},120);
