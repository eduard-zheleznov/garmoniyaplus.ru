;(function(){
try{
if(window.__gpActionsSync20260618Full86)return;
window.__gpActionsSync20260618Full86=true;
...
function ensureMobileHeader83Style(){
  ...
  style.textContent=[
    ...
    "@media (max-width:1023px){[data-mobile-shell='header'] button[aria-label='Поиск']{min-width:2.82rem!important}[data-mobile-shell='header'] button[aria-label='Поиск'] svg{width:20px!important;height:20px!important;min-width:20px!important;min-height:20px!important;scale:1!important}[data-mobile-shell='header'] button[aria-label='Поиск'] span[class*='text-[9px]']{font-size:9px!important;line-height:9px!important;height:9px!important}}"
  ].join("");
  document.head.appendChild(style);
}
...
function ensureAndroidFast84Style(){
  ...
  style.textContent=[
    "@media (max-width:640px){body.gp-pravki-current-account [data-mobile-shell='header']{height:66px!important;min-height:0!important;max-height:66px!important;border-bottom:1px solid rgba(255,255,255,.94)!important;box-shadow:none!important;overflow:hidden!important}}",
    "@media (max-width:640px){body.gp-pravki-current-account [data-mobile-shell='header']>div:first-child{padding-bottom:0!important}}",
    "@media (max-width:640px){body.gp-pravki-current-account{padding-top:66px!important}}",
...
function normalizeAndroidAccountHeader84(){
  ...
  var header=document.querySelector('[data-mobile-shell="header"]');
  if(header){
    header.style.setProperty("height","66px","important");
    header.style.setProperty("min-height","0px","important");
    header.style.setProperty("max-height","66px","important");
  ...
  document.body.style.setProperty("padding-top","66px","important");
