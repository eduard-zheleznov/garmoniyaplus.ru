...
function gpFinalUxNormalizeCopy(){
  ...
  if(path==="/promotions"){
    ...
    [].slice.call(main.querySelectorAll("article")).forEach(function(card){
      ...
      if(badge)badge.classList.add("gp-final-promo-badge");
