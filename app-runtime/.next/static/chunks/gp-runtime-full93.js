;(function(){
try{
if(window.__gpActionsSync20260618Full93)return;
window.__gpActionsSync20260618Full93=true;
...
function ensureFavoritesCard93Style(){
  if(document.getElementById("gp-favorites-empty93-style"))return;
  var style=document.createElement("style");
  style.id="gp-favorites-empty93-style";
  style.textContent=[
