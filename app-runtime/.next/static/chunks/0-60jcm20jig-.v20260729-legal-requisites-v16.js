...
try{
  ...
  function gpApplyRequisitesInlineSize(){
    ...
    [].slice.call(details.children).forEach(function(row,index){
      ...
      gpSetRequisitesInlineStyle(row,"justify-content","space-between");
      gpSetRequisitesInlineStyle(row,"gap",".9rem");
      ...
      gpSetRequisitesInlineStyle(label,"flex","0 0 auto");
      gpSetRequisitesInlineStyle(label,"margin","0");
      gpSetRequisitesInlineStyle(label,"text-align","left");
      gpSetRequisitesInlineStyle(label,"font-size",desktop?".76rem":".72rem");
      ...
      gpSetRequisitesInlineStyle(value,"font-size",desktop?"clamp(1.05rem,1.18vw,1.13rem)":"1rem");
