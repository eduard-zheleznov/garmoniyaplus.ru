;(function(){
try{
if(window.__gpActionsSync20260618Full87)return;
window.__gpActionsSync20260618Full87=true;
...
function ensureAndroidFast84Style(){
  ...
  style.textContent=[
    "@media (max-width:640px){body.gp-pravki-current-account [data-mobile-shell='header']{height:58px!important;min-height:0!important;max-height:58px!important;border-bottom:1px solid rgba(255,255,255,.94)!important;box-shadow:none!important;overflow:hidden!important}}",
    "@media (max-width:640px){body.gp-pravki-current-account [data-mobile-shell='header']>div:first-child{padding-bottom:0!important}}",
    "@media (max-width:640px){body.gp-pravki-current-account{padding-top:58px!important}}",
...
function normalizeAndroidAccountHeader84(){
  ...
  if(header){
    ...
    header.style.setProperty("max-height","58px","important");
  ...
  document.body.style.setProperty("padding-top","58px","important");
