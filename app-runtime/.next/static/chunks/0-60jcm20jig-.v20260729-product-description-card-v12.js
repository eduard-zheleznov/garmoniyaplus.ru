...
;(function(){
try{
  var gpProductDescriptionCardStyleId="gp-product-description-card-v20260729";
  var gpProductDescriptionCardObserver=null;
  ...
  function gpApplyProductDescriptionCard(){
    ...
    var productHeading=main.querySelector("h1");
    var productHero=productHeading&&productHeading.closest("section");
    if(productHero){
  ...
  function gpScheduleProductDescriptionCard(){
    ...
    [0,320,900,1900,3200].forEach(function(delay){setTimeout(gpApplyProductDescriptionCard,delay);});
    if(gpProductDescriptionCardObserver||!document.documentElement)return;
    gpProductDescriptionCardObserver=new MutationObserver(gpApplyProductDescriptionCard);
    gpProductDescriptionCardObserver.observe(document.documentElement,{childList:true,subtree:true,attributes:true,attributeFilter:["class"]});
    setTimeout(function(){
      if(gpProductDescriptionCardObserver){gpProductDescriptionCardObserver.disconnect();gpProductDescriptionCardObserver=null;}
    },4500);
  }
